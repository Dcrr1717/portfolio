...
export const projects: Project[] = [
  ...
  },
  {
    slug: "rnn-cosmos",
    index: "04",
    title: "Recurrent Neural Networks, Visualized in 3D",
    category: "AI · 3D / WebGL",
    pillar: "AI / Machine Learning",
    year: "2026",
    role: "Concept, graphics & in-browser ML",
    motif: "cosmos",
    oneLiner:
      "A real-time 3D visualization of a recurrent neural network, with inference running in the browser.",
    summary:
      "An experiment that lifts a recurrent neural network into a navigable 3D space, with inference running client-side via TensorFlow.js and WebGL rendering through React Three Fiber.",
    problem:
      "The dynamics of a recurrent network are hard to intuit from flat plots. I wanted a spatial, interactive representation that made the model's behavior visible — with no server required.",
    contributions: [
      "3D scene with React Three Fiber and three.js, tuned to hold 60 fps.",
      "Client-side model inference with TensorFlow.js (no backend).",
      "Fluid interaction and transitions; deployed on Vercel.",
    ],
    tech: [
      { group: "3D / WebGL", items: ["React Three Fiber", "three.js", "@react-three/drei"] },
      { group: "AI", items: ["TensorFlow.js"] },
      { group: "Framework", items: ["Next.js", "React"] },
    ],
    metrics: [
      { label: "Render", value: "WebGL" },
      { label: "Inference", value: "Client" },
