    ...
    <section id="skills" class="border-y border-line bg-surface-2/40">
      <div class="mx-auto max-w-6xl scroll-mt-24 px-4 py-24 sm:px-6 md:py-32">
        <SectionHeader
          index="02"
          label="Skills"
          title="The stack I use, proven in real code."
          lede="Not a wishlist: every technology here shows up in at least one of the projects above."
        />
              ...
              <div class="h-full bg-surface p-6 sm:p-7">
                ...
                <ul class="flex flex-wrap gap-1.5">
                  {group.items.map((item) => (
                    <li
                      key={item}
                      class="rounded-full border border-line bg-surface-2 px-3 py-1 text-[13px] text-ink-secondary"
                    >
                      {item}
                    </li>
                  ))}
